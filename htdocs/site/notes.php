...
<!-- Meio -->
    ...
    <!-- Banner Rotativo -->
    <div id="slides">
        <a href="servidores.php"><img src="images/slider/imagem1.png" width="100%" height="100%"></a>
        <a href="grancastle.php"><img src="images/slider/imagem2.png" width="100%" height="100%"></a>
        <a href="skills.php"><img src="images/slider/imagem3.png" width="100%" height="100%"></a>
    </div>
    <!-- /Banner Rotativo -->
    <br>
    ...
    <td valign="top">
        <br>
            ...
            <tr>
                <td colspan=2><img src=""> <font class=f2><font color=orange>Eagle World</font> <a href="servidores.php"><font color="lightblue">(+)</font></a></font></td>
            </tr>
            <tr>
                <td><font class=f1><b>IP&nbsp;Address:</b></font></td>
                <td width="290"><font class=f1><font color=white>eagleworld.servegame.com</font></font></td>
            </tr>
            <tr>
                <td><font class=f1><b>Port:</b></font></td>
                <td width="290"><font class=f1><font color=white>7171</font></font></td>
            </tr>
            <tr>
                <td><font class=f1><b>Protocol:</b></font></td>
                <td width="290"><font class=f1><font color=white>8.40</font></font></td>
            </tr>
            <tr>
                <td><font class=f1><b>Frags:</b></font></td>
           ...
           <table border=1 cellpadding=1 cellspacing=1 width="280">
            ...
            <tr>
                <td><font class=f1><b>IP&nbsp;Address:</b></font></td>
                <td width="290"><font class=f1><font color=white>In Construction</font></font></td>
            </tr>
            <tr>
                <td><font class=f1><b>Port:</b></font></td>
                <td width="290"><font class=f1><font color=white>7171</font></font></td>
